...
actor_lr=0.00003
client_actor_warmup_rounds=4
client_upload_blend=0.15
client_validation_episodes=2
client_rollback_margin=0.03
inject_margin=0.0
global_delta_clip_norm=0.5
migration_copies=1
migration_blend=0.25
inject_noise=0.002
candidate_pool=softmax_plus_validated_clients
seeds=$SEEDS
