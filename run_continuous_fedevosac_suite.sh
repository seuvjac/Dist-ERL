...
ENVS=${ENVS:-"Swimmer-v5 Walker2d-v5 Hopper-v5 Ant-v5 HalfCheetah-v5"}
SEEDS=${SEEDS:-"0 1"}
...
PY
  ...
  case "$ENV_NAME" in
    Ant-v5)
      ...
      ;;
    HalfCheetah-v5)
      POP=${FED_HALFCHEETAH_POPULATION_SIZE:-${FED_POPULATION_SIZE:-16}}
      STEPS=${FED_MAX_EPISODE_STEPS:-1000}
      ...
      ARCHIVE_EVAL_CANDIDATES=${FED_HALFCHEETAH_ARCHIVE_EVAL_CANDIDATES:-3}
    ...
    Swimmer-v5)
      ...
      STAGNATION_PATIENCE=${FED_SWIMMER_STAGNATION_PATIENCE:-4}
      STAGNATION_MIN_DELTA=${FED_SWIMMER_STAGNATION_MIN_DELTA:-3.0}
      IMMIGRANT_FRACTION=${FED_SWIMMER_IMMIGRANT_FRACTION:-0.25}
