...
PY
  ...
  case "$ENV_NAME" in
    ...
    Hopper-v5)
      ...
      ENV_CLIENT_HETEROGENEITY=${FED_HOPPER_CLIENT_HETEROGENEITY:-$ENV_CLIENT_HETEROGENEITY}
      ENV_CLIENT_HETEROGENEITY_MODE=${FED_HOPPER_CLIENT_HETEROGENEITY_MODE:-$ENV_CLIENT_HETEROGENEITY_MODE}
      ;;
    Walker2d-v5)
